...
<?php if($status == "biometrics"){?>
    ...
    <br><br>
    <div class="user-experience container col-md-5 col-md-offset-3">
        <?php $form = ActiveForm::begin(['options' => ['id' => 'regForm', 'enctype' => 'multipart/form-data']]) ?>
            <div class="panel panel-default">
                
                <div class="panel-heading">
                    <h2 class="panel-title">Add your biometrics</h2>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="tab">
                        <div class="col-sm-12">
                            ...
                            <br><br>
                            <h4 class="panel-title" style="margin-top:70px;">Age:</h4>
                            <div class="range range-primary">
                                <!--<input type="range" name="Biometrics[age]" min="1" max="100" value="50" onmousemove="rangePrimary.value=value">-->
                                <input type="range" min="1" max="100" name="Biometrics[age]" value="100" class="slider" id="myRange-1"  onmousemove="rangePrimary.value=value">
                                <output id="rangePrimary">100</output>
                            </div>
                        </div>
                    ...
                    <div class="tab">
                        <div class="col-sm-12">
                            <br><br>
                            <h4 class="panel-title">Height:</h4>
                            <div class="range range-success">
                                <input type="range" min="1" max="300" value="300" name="Biometrics[height]" class="slider" id="myRange-2"  onmousemove="rangeSuccess.value=value">
                                <output id="rangeSuccess">300</output>
                            ...
                            <div class="range range-warning">
                                <input type="range" name="Biometrics[weight]" min="1" max="200" value="200" class="slider" id="myRange-3" onmousemove="rangeWarning.value=value">
                                <output id="rangeWarning">200</output>
                            </div>
                        </div>
                    </div><div style="clear: both;"></div>
                    ...
                    <div class="tab">
                        <div class="col-sm-12">
                            ...
                            <div>
                                ...
                                <label for="radio22">Leggera perdita di peso</label>
                            </div>

                            <div>
                                <input type="radio" name="Biometrics[target]" id="radio33" class="radio" value="Ricerca del mantenimento del benessere personale"/>
                                <label for="radio33"><span>Ricerca del mantenimento del benessere personale</span></label>
                            </div>

                            <div>
                                <input type="radio" name="Biometrics[target]" id="radio44" class="radio" value="Leggera crescita di massa muscolare"/>
                                <label for="radio44"><span>Leggera crescita di massa muscolare</span></label>
                            </div>

                            <div>
                                <input type="radio" name="Biometrics[target]" id="radio55" class="radio" value="Forte crescita di massa muscolare"/>
                                <label for="radio55">Forte crescita di massa muscolare</label>
                            </div>
                        </div>
                    </div><div style="clear: both;"></div>
                    ...
                    <div class="tab">
                        <div class="col-sm-12">
                            ...
                            <div>
                                ...
                                <label for="radio111">Sedentario</label>
                            </div>
                    ...
                    <div class="tab">
                        <div class="col-sm-12">
                            <br><br>
                            <h4 class="panel-title">lactose_intolerance?</h4>
                            <div>
                    ...
                    <div class="tab">
                        <div class="col-sm-12">
                            <br><br>
                            <h4 class="panel-title">gluten_celiac_intolerance?</h4>
                            <div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="check-box-mania">
                                ...
                                <div class="form-check">
                                    <label>
                                        <input type="checkbox" name="MoreBiometrics[diabete]" value="Si"> <span class="label-text">diabete di tipo 1 o 2</span>
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label>
...
<?php if($status == "result") {$this->params['breadcrumbs'][] = ['label' => 'Results', 'url' => ['index']]; ?>
    ...
    <style type="text/css">
        ...
        .modal-body tbody tr td:nth-child(3) {
            border-right: 2px solid #a5a2a2 !important;
        }
        .modal-body thead th {
            font-size: 20px;
            text-align: center;
