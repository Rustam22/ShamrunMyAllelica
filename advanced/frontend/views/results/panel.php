    ...
    <div class="user-experience container col-md-6 col-md-offset-3">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <h2 class="panel-title" style="text-align:center;color: #5e5e5e;font-size: 25px;">Parlaci di te</h2>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="tab">
                    <div class="col-sm-8 col-md-offset-2">
                        ...
                        <div class="range range-success">
                            ...
                            <!--<input type="range" name="Biometrics[height]" min="1" max="300" value="180" onmousemove="rangeSuccess.value=value">
                            <output id="rangeSuccess">180</output>-->
                        </div><br>
                ...
                <div class="tab">
                    <div class="col-sm-8 col-md-offset-2">
                        <br><br>
                        <h4 class="panel-title">Sai già di essere intollerante al lattosio</h4>
                        <div>
                ...
                <div class="tab">
                    <div class="col-sm-8 col-md-offset-2">
                        <br><br>
                        <h4 class="panel-title">Sai già di essere celiaco</h4>
                        <div>
                ...
                <div class="tab">
                    <div class="col-sm-8 col-md-offset-2">
                        <br><br>
                        <h4 class="panel-title">Hai altre informazioni che potrebbero essere utili?</h4>
                        ...
                        <div class="check-box-mania">
                            ...
                            <!--<div class="form-group">
                                <label for="comment" class="textarea-for-other">Altre informazioni che reputi importanti</label>
...
<!--
		<?php 
	$active = "";
	if($product == 'Nutrizione') $active = " active";?>
                        <a href="<?php echo Yii::$app->homeUrl; ?>results?product=Nutrizione" style="font-size: 27px!important;margin-top: 35px;width: 30%;
    border-radius: 7px;float: left;" class="btn btn-success btn-lg <?php echo $active;?>" role="button" aria-pressed="true">
                Nutrizione
            </a>
<?php
	$active = "";
	if($product == 'Prevenzione') $active = " active";?>
            <a href="<?php echo Yii::$app->homeUrl; ?>results?product=Prevenzione" style="font-size: 27px!important;width: 30%;
    border-radius: 7px;margin-top: 35px;float: right;" class="btn btn-primary btn-lg <?php echo $active;?>" role="button" aria-pressed="true">
                Prevenzione
            </a>
<?php	$active = "";
	if($product == 'Dieta') $active = " active";?>
            <a href="<?php echo Yii::$app->homeUrl; ?>diet" style="font-size: 27px!important;margin-top: 35px;width: 30%;border-radius: 7px;float: left;margin-left:5%" class="btn btn-success btn-lg piano <?php echo $active;?>" role="button" aria-pressed="true" >
                Piano nutrizionale
            </a>
-->
...
<?php if($status == "result") {$this->params['breadcrumbs'][] = ['label' => 'Results', 'url' => ['index']]; ?>
    ...
    <script>
        ...
        function doChart() {
            ...
            dbPercentile = 80;          // given percintile
            ...
            console.log(indexFor25 + ' - ' + values[indexFor25] + ' - ');
            ...
            console.log(plotBandsOptions25);
                    ...
                    events: {
                        ...
                        load: function (e) {
                            if(screen.width < 800) {
                                w = this.chartWidth;
                                this.setSize(w,'250');
                                $('#container').addClass('gaussianShort');
                                $('#poche').addClass('gaussianShort');
                                $('#molte').addClass('gaussianShort');
                                $('.highcharts-legend').hide();
                                var miniLegend = '<div class="miniLegend"><div class="blu">Popolazione europea</div><div class="verde">Il tuo punteggio</div></div>';
                                $('.info').before(miniLegend);
                            }
    ...
    <style>
        ...
        .miniLegend .blu:before {
            content: '\f068';
            color: rgb(56,176,190);
            font-family: FontAwesome;
            padding-right: 2px;
        }
        .miniLegend .verde:before {
            content: '\f068';
            color: green;
            font-family: FontAwesome;
            padding-right: 2px;
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            function doDataTable(dataSet) {
                ...
                /*
                            ...
                            paging: false,
                                ...
                                $('.modal-body thead tr th:nth-child(3)').html('Variante con rischio');
                                $('.modal-body thead tr th:nth-child(3)').css('width','180px');
                                $('.modal-body tbody tr td:nth-child(3)').css('width','180px');
                */
            }
            ...
            $('.user-experience .main-nav #nav-tabs-wrapper li a').click(function () {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#container').removeClass('gauge');
                        $('.panel-body').removeClass('gauge-main');
            ...
            $('.read-more').click(function () {
                $('.gauge-main').addClass('no-index');
                setTimeout(function(){
                    $('.dataTables_scrollHeadInner th:first').click();
                    $('.dataTables_scrollHeadInner th:first').click();
                },500);
            });
            $('#data-table').on('hidden.bs.modal', function () {
                $('.gauge-main').removeClass('no-index');
            });
        ...
        $(document).on('click','#nav-tabs-wrapper li', function () {
            console.log('to top');
            $(window).scrollTop(0);
        });
    ...
    <style type="text/css">
        ...
        @media screen and (max-width: 800px) {
            ...
            .user-experience .panel-body.gauge-main {
                position: relative;
                z-index: 50;

            }
            .user-experience .gauge-main #container {
                position: relative;
                z-index: -1;
        ...
        /*
            .modal-body thead tr th:last-child {
                display: none;
            }
            .modal-body thead tr th:nth-child(4) {
                text-align: center;
            ...
            .modal-body .dataTables_scrollBody tbody tr td:first-child, thead tr th:first-child {
                display: none;
            }
        ...
        /*.modal-body tbody tr td:nth-child(4), td:nth-child(5) {
            display: none;
        }
        .modal-body thead tr th:nth-child(4) {
            display: none;
        ...
        <div class="row">
            ...
            <div class="row col-sm-9 unmargin">
                <div class="panel panel-primary ">
                    ...
                    <div class="panel-body">
                        <h2 class="headers-for-subheaders">I tuoi risultati</h2>
                        <div id="subHeader">#</div>
                        <h2 class="headers-for-subheaders advice">I nostri consigli</h2>
