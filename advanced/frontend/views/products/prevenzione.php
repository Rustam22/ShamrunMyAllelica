...
<section class="feature section iframe-section" style="padding-bottom: 0px;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 sub-container" style="width: 100%;">
                <div class="content mt-100" style=" margin-right: 10px;">
                    <h2 class="subheading" style="text-align: center;">La conoscenza può allungarti la vita:</h2>
                    <p style="">
                        Molte malattie possono essere prevenute con uno stile di vita adeguato, ti forniremo tutte le informazioni per iniziare da subito il tuo percorso di prevenzione. <br/>
                        <br/>
                        Le varianti genetiche che utilizziamo per individuare le tue predisposizioni sono state validate in studi pubblicati su riviste scientifiche ad alto impact factor, accettate e validate dalla comunità scientifica. </p>
                </div>
                <br><br>
                <div class="embed-responsive embed-responsive-16by9" style="display: none;">
                    <h2 class="subheading" style="text-align: center;">Come fare il test Allelica:<br></h2>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 sub-container" style="width: 100%;">
                <div class="content mt-100" style="float: left; margin-right: 10px; width: 50%;">
                    ...
                    <br>
                    <p>Ricevi il kit con un tampone, utilizzalo e rimandacelo gratuitamente.<br><br> Otterrai il report con le tue predisposizioni alle malattie comodamente a casa tua.</p><br/><br/>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6" style="width: 100%;">
                <div class="block different">
                    ...
                    <h2 class="subheading">Scoprirai le predisposizione per le seguenti malattie:</h2>
                    <ul>
                        <li>Malattie Cardiovascolari (Coronaropatie, Trombofilia)</li>
                        <li>Cancro al colon</li>
                        <li>Cancro al seno</li>
                        <li>Parkinson</li>
                        <li>Alzheimer</li>
                        <li>Malattie metaboliche (Diabete tipo 2, Sindrome Metabolica)</li>
                        <li>Malattie respiratorie (Asma, Apnee notturne)</li>
                        <li>Malattie della pelle (Dermatiti)</li>
                        <li>Malattie delle ossa (Osteoporosi, Artriti)</li>
                        <li>Inestetismi della pelle (Rughe, Cellulite, Vene Varicose, Smagliature)</li>
                        <li>Insufficienza renale</li>
                        <li>Rischio infortuni (Tendinopatie, Lussazione della Spalla)</li>

                        <!-- <li>Quali cibi magiare per minimizzare i tuoi sintomi indesiderati.</li>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-12">
                <div class="feature-box">
                    ...
                    <h4>Benessere</h4>
                    <p>Grazie alle informazioni contenute nel tuo DNA scopri qual è il percorso di prevensione ideale per il tuo organismo.</p>
                </div>
                <div class="feature-box">
                    <i class="fa fa-search" aria-hidden="true"></i>
                    <!--i class="tf-ion-ios-alarm-outline"></i-->
                    <h4>Il più accurato di sempre</h4>
                    <p>Siamo gli unici ad analizzare più di 650.000 variazioni genetiche, garantendoti un'analisi completa del tuo Genoma.</p>
                </div>
                <div class="feature-box">
            ...
            <div class="col-md-3 col-sm-12">
                ...
                <div class="feature-box">
                    ...
                    <h4>Velocità</h4>
                    <p>Con un unico test ottieni informazioni complete sui rischi di sviluppare numerose malattie. Avrai i risultati entro due settimane dall'arrivo del campione al laboratorio.</p>
                </div>
                <div class="feature-box">
            ...
            <div class="col-md-12 wow text-center">
                <div class="block">
                    ...
                    <p style="color: white !important; font-size: 21px;text-align: center;">
                        ...
                        Allelica si impegna a fornirti le raccomandazioni scientifiche piu efficaci e aggiornate di sempre per aiutarti a capire come preveniere le malattie per cui puoi essere predisposto.<br>
                        La scienza genomica e' in continua evoluzione, se ci saranno delle modifiche alle informazioni fornite te lo comunicheremo immediatamente.<br>Ci impegnamo con te ad avere una relazione duratura e stabile in modo che avrai sempre le migliori informazioni per sapere qual'è il percorso di prevenzione più efficace per te.
                    </p>
                    <div class="col-lg-6 offset-lg-3 buttonica">
                        <br>
                        <a class="btn btn-main cta" id="impegno" style="background: rgba(27,168,183,.9); -webkit-box-shadow: none;"  href="<?php echo Yii::$app->homeUrl; ?>acquista/prevenzione" role="button" style="margin-top:20px;">Compra ora &euro;169</a>
